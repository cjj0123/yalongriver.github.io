...
XUEQIU_STATUS_IDS = [
    status_id.strip()
    for status_id in os.environ.get("XUEQIU_STATUS_IDS", "395752602,395690742,395607216,395104103,394878166,394700390,394539731,394304756,394086059,393824168,393149445").split(",")
    if status_id.strip()
]
